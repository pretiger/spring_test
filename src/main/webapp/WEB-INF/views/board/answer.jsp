...
<form name="form1" method="post" enctype="multipart/form-data">
	<table border="1" style="width: 700px;">
		<tr>
			...
			<td><input type="text" size="60" name="subject" id="subject" value="${dto.subject}"/></td>
		</tr>
		<tr>
		...
		<tr align="center">
			<td colspan="2">
				...
				<input type="hidden" value="${dto.subgroup}" name="subgroup">
				<input type="hidden" value="${dto.substep}" name="substep">
				<input type="hidden" value="${dto.sublevel}" name="sublevel">
